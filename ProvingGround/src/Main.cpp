...
static auto s_MouseTexture = 
	pul::Texture(pul::Window::getRenderer(), "assets/Mouse.png");
static auto s_EnemyTexture = 
	pul::Texture(pul::Window::getRenderer(), "assets/Enemy.png");
static auto s_FlexTexture =
	pul::Texture(pul::Window::getRenderer(), "assets/Flex.png");

static auto s_Mouse =
	pul::Entity(s_MouseTexture, 
		eqx::Rectangle<double>(0.0, 0.0, 50.0, 50.0), pul::Entity::c_MaxSpeed);
static auto s_Unit = 
	pul::Entity(s_EnemyTexture, 
		eqx::Rectangle<double>(500.0, 500.0, 100.0, 100.0), 2'000);
static auto s_Blade =
...
void Game::update()
{
	...
	auto dt = pul::Window::getDeltaTime();
	...
	{
		timer.start();
		std::cout << pul::Window::getFPSInfo() << std::endl;
	}
}
